...
SOURCE_PROFILES: tuple[SourceProfile, ...] = (
    ...
    SourceProfile(
        key="afdb",
        source_kind="listing",
        domains=("afdb.org/fr/appels", "afdb.org/en/calls", "afdb.org"),
        organism_markers=("african development bank", "banque africaine de developpement", "afdb", "bad"),
        title_fields=("title", "name", "nom", "titre"),
        short_description_fields=("summary", "resume", "description", "excerpt"),
        full_description_fields=("content", "body", "description", "details", "overview"),
        eligibility_fields=("eligibility", "criteria", "conditions", "requirements", "eligibilite"),
        funding_fields=("funding", "grant", "amount", "award", "budget", "financement"),
        procedure_fields=("application", "how_to_apply", "procedure", "contact", "submission"),
        close_date_fields=("deadline", "close_date", "closing_date", "date_limite", "date_cloture"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
            "allow_english_text": True,
    ...
    SourceProfile(
        key="proparco",
        source_kind="listing",
        domains=("proparco.fr/fr/appels", "proparco.fr"),
        organism_markers=("proparco", "afd", "agence francaise de developpement"),
        title_fields=("title", "name", "nom", "titre"),
        short_description_fields=("summary", "resume", "description", "presentation", "accroche"),
        full_description_fields=("content", "body", "description", "details", "contenu"),
        eligibility_fields=("eligibility", "criteria", "conditions", "eligibilite", "criteres"),
        funding_fields=("funding", "grant", "amount", "montant", "financement", "subvention"),
        procedure_fields=("application", "procedure", "contact", "candidature", "dossier"),
        close_date_fields=("deadline", "close_date", "date_limite", "cloture"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
    ...
    SourceProfile(
        key="giz_africa",
        source_kind="listing",
        domains=("giz.de/en/worldwide/west_africa", "giz.de/en/html/calls", "giz.de"),
        organism_markers=("giz", "deutsche gesellschaft", "cooperation technique allemande"),
        title_fields=("title", "name", "nom"),
        short_description_fields=("summary", "teaser", "description", "excerpt"),
        full_description_fields=("content", "body", "description", "details", "richtext"),
        eligibility_fields=("eligibility", "criteria", "conditions", "requirements", "who_can_apply"),
        funding_fields=("funding", "grant", "amount", "award", "budget"),
        procedure_fields=("application", "how_to_apply", "procedure", "contact", "submission"),
        close_date_fields=("deadline", "close_date", "closing_date", "date_limite"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
            "allow_english_text": True,
    ...
    SourceProfile(
        key="agra",
        source_kind="listing",
        domains=("agra.org/grants", "agra.org/calls", "agra.org"),
        organism_markers=("agra", "alliance for a green revolution", "alliance pour une revolution verte"),
        title_fields=("title", "name", "nom"),
        short_description_fields=("summary", "excerpt", "description", "teaser"),
        full_description_fields=("content", "body", "description", "details", "overview"),
        eligibility_fields=("eligibility", "criteria", "conditions", "requirements", "who_can_apply"),
        funding_fields=("funding", "grant", "amount", "award", "budget"),
        procedure_fields=("application", "how_to_apply", "procedure", "contact", "apply"),
        close_date_fields=("deadline", "close_date", "closing_date", "date_limite"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
    ...
    SourceProfile(
        key="usaid_africa",
        source_kind="listing",
        domains=("usaid.gov/west-africa", "usaid.gov/sub-saharan-africa", "usaid.gov"),
        organism_markers=("usaid", "united states agency for international development"),
        title_fields=("title", "name", "nom"),
        short_description_fields=("summary", "description", "excerpt", "field--name-body"),
        full_description_fields=("content", "body", "description", "details", "field--name-body"),
        eligibility_fields=("eligibility", "criteria", "conditions", "requirements"),
        funding_fields=("funding", "grant", "amount", "award", "budget", "cooperative_agreement"),
        procedure_fields=("application", "how_to_apply", "procedure", "contact", "solicitation"),
        close_date_fields=("deadline", "close_date", "closing_date", "due_date"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
            "allow_english_text": True,
    ...
    SourceProfile(
        key="boad",
        source_kind="listing",
        domains=("boad.org/appels", "boad.org"),
        organism_markers=("boad", "banque ouest africaine de developpement"),
        title_fields=("title", "name", "nom", "titre"),
        short_description_fields=("summary", "resume", "description", "accroche"),
        full_description_fields=("content", "body", "description", "details", "contenu"),
        eligibility_fields=("eligibility", "criteria", "conditions", "eligibilite", "criteres"),
        funding_fields=("funding", "grant", "amount", "montant", "financement"),
        procedure_fields=("application", "procedure", "contact", "candidature", "soumission"),
        close_date_fields=("deadline", "close_date", "date_limite", "cloture"),
        default_device_type="subvention",
        default_status_without_close_date="standby",
        config_overrides={
